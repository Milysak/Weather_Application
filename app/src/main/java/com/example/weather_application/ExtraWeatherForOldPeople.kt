...
import com.example.weather_application.databinding.FragmentExtraWeatherForOldPeopleBinding
 ...
 * Use the [ExtraWeatherForOldPeople.newInstance] factory method to
 * create an instance of this fragment.
 */

class ExtraWeatherForOldPeople : Fragment() {
    // TODO: Rename and change types of parameters
    private var param1: String? = null
    private var param2: String? = null

    private var _binding: FragmentExtraWeatherForOldPeopleBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentExtraWeatherForOldPeopleBinding.inflate(inflater, container, false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // Do przełączania widoku
        val zoomOutButton = view.findViewById<Button>(R.id.switchToZoomedView)
        zoomOutButton.setOnClickListener {
            ...
            Navigation.findNavController(view).navigate(R.id.action_extraWeatherForOldPeople_to_noExtraWeatherFragment, bundle)
        }

        // Klient do wysyłania zapytań
        val okHttpClient = OkHttpClient()

        // Do czytania JSONa
        var jsonObject: JSONObject? = null

        // Funkcja, w której ciele wysyła się request i zczytuje response
        fun findWeather() {
                ...
                okHttpClient.newCall(request).enqueue(object : Callback {
                    ...
                    override fun onResponse(call: Call, response: Response) {
                        response.use {
                            ...
                            // Ustawianie wartości dla odpowiednich pól w UI
                            Handler(Looper.getMainLooper()).post(Runnable {
                                binding.inputNameOfCityField.text?.clear()

                                binding.instructionField.isVisible = false
        ...
        // Czytanie nazwy miejcowości w bundle - jeśli jest to wyszukaj po tej nazwie pogodę
